...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  },
  {
    ...
    icon: "Activity",
    tier: "gold",
    earned: (s) => s.counters.questsCompleted >= 50,
    progress: (s) => ratio(s.counters.questsCompleted, 50),
  },
  {
    ...
    progress: (s) => ratio(s.streak.best, 14),
  },
  {
    id: "daily-devotee",
    title: "Daily Devotee",
    description: "Claim 5 daily rewards.",
    icon: "Clock",
    tier: "silver",
    earned: (s) => s.counters.dailyClaims >= 5,
    progress: (s) => ratio(s.counters.dailyClaims, 5),
  },
  {
    id: "shopaholic",
    title: "Shopaholic",
    description: "Own 3 shop cosmetics.",
    icon: "Sparkles",
    tier: "silver",
    earned: (s) => s.ownedCosmetics.length >= 3,
    progress: (s) => ratio(s.ownedCosmetics.length, 3),
  },
  {
    id: "coin-hoarder",
    title: "Coin Hoarder",
    ...
    icon: "Trophy",
    tier: "gold",
    earned: (s) => s.coins >= 500,
    progress: (s) => ratio(s.coins, 500),
  },
];
